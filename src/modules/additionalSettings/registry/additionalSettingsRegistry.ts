...
const TRANSACTION_ACCOUNTING_SUBCATEGORIES: readonly AdditionalSettingSubcategoryDefinition[] =
  [
    ...
    {
      code: AdditionalSettingsCodeEnum.CardClosingControlAccount,
      label: 'CARD CLOSING CONTROL ACCOUNT (CLOCC)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CARD closing control account',
      optionsSource: 'account-profile',
    },
    {
    ...
    {
      code: AdditionalSettingsCodeEnum.CmSellControlAccount,
      label: 'CM SELL CONTROL ACCOUNT (SELLCM)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CM sell control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.CmClosingControlAccount,
      label: 'CM CLOSING CONTROL ACCOUNT (CLOCM)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CM closing control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.CmControlAccount,
      label: 'CM CONTROL ACCOUNT (CRDCM)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CM control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.CmPurchaseControlAccount,
      label: 'CM PURCHASE CONTROL ACCOUNT (PURCM)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CM purchase control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.CmProfitControlAccount,
      label: 'CM PROFIT CONTROL ACCOUNT (PROCM)',
      valueType: 'select',
      required: true,
      placeholder: 'Select CM profit control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.TtSellControlAccount,
      label: 'TT SELL CONTROL ACCOUNT (SELLTT)',
      valueType: 'select',
      required: true,
      placeholder: 'Select TT sell control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.TtClosingControlAccount,
      label: 'TT CLOSING CONTROL ACCOUNT (CLOTT)',
      valueType: 'select',
      required: true,
      placeholder: 'Select TT closing control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.TtControlAccount,
      label: 'TT CONTROL ACCOUNT (CRDTT)',
      valueType: 'select',
      required: true,
      placeholder: 'Select TT control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.TtPurchaseControlAccount,
      label: 'TT PURCHASE CONTROL ACCOUNT (PURTT)',
      valueType: 'select',
      required: true,
      placeholder: 'Select TT purchase control account',
      optionsSource: 'account-profile',
    },
    {
      code: AdditionalSettingsCodeEnum.TtProfitControlAccount,
      label: 'TT PROFIT CONTROL ACCOUNT (PROTT)',
      valueType: 'select',
      required: true,
      placeholder: 'Select TT profit control account',
      optionsSource: 'account-profile',
    },
    {
...
const TRANSACTION_NUMBERING_SUBCATEGORY_CONFIG: Partial<
  Record<
...
const CARD_TECHNICAL_NUMBERING_SUBCATEGORIES: readonly AdditionalSettingSubcategoryDefinition[] =
  [
    {
      code: AdditionalSettingsCodeEnum.CardTransferOutNumberSeries,
      label: 'CARD TRANSFER OUT',
      valueType: 'number',
      required: true,
      placeholder: 'Enter starting sequence number',
    },
    {
      code: AdditionalSettingsCodeEnum.CardTransferInNumberSeries,
      label: 'CARD TRANSFER IN',
      valueType: 'number',
      required: true,
      placeholder: 'Enter starting sequence number',
    },
    {
      code: AdditionalSettingsCodeEnum.CardStockLoadNumberSeries,
      label: 'CARD STOCK LOAD',
      valueType: 'number',
      required: true,
      placeholder: 'Enter starting sequence number',
    },
    {
      code: AdditionalSettingsCodeEnum.CardSettleNumberSeries,
...
const VOUCHER_NUMBERING_SUBCATEGORIES: readonly AdditionalSettingSubcategoryDefinition[] =
  [
    {
      code: AdditionalSettingsCodeEnum.ReceiptVoucherNumberSeries,
    ...
    {
      code: AdditionalSettingsCodeEnum.PaymentVoucherNumberSeries,
    ...
    {
      code: AdditionalSettingsCodeEnum.JournalVoucherNumberSeries,
...
export const getAdditionalSettingCategoryCodeOptions =
...
export const getAdditionalSettingSubcategoryCodeOptions = (
  ...
  getAdditionalSettingCategoryDefinition(categoryCode)?.subcategories.map(
    definition => ({
      value: definition.code,
      label: definition.label,
    })
...
export const isRegisteredAdditionalSettingCategoryCode = (
  code?: string | null
...
export const isRegisteredAdditionalSettingSubcategoryCode = (
  ...
  Boolean(
    getAdditionalSettingSubcategoryDefinition(categoryCode, subcategoryCode)
  );
