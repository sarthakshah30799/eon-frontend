...
interface BuyFromBookReferenceFieldProps {
  branchId?: string;
  disabled?: boolean;
}
...
export const BuyFromBookReferenceField = ({
  branchId,
  disabled = false,
}: BuyFromBookReferenceFieldProps) => {
    ...
    <>
      <div className="grid gap-4 md:grid-cols-2">
        ...
        {isDeliveryBoyMode ? (
          <EntityPickerField
            label="Delivery Boy"
            value={formatBuyFromEntityLabel(
              deliveryBoyUserCode,
              deliveryBoyUserName
            )}
...
export default BuyFromBookReferenceField;
