...
export const PRODUCT_PROFILE_ACCOUNTING_FIELDS: IProductProfileFieldConfig[] = [
  ...
  { name: 'lossAccount', label: 'Loss Account' },
  ...
  { name: 'bulkSaleAc', label: 'Bulk Sell Account' },
  { name: 'purchaseAc', label: 'Purchase Account' },
  { name: 'saleAc', label: 'Sell Account' },
  ...
  { name: 'saleRetCancAc', label: 'Sell Return Cancellation Account' },
  { name: 'saleBlkCancAc', label: 'Sell Bulk Cancellation Account' },
  { name: 'branchPurAc', label: 'Branch Purchase Account' },
  { name: 'branchSaleAc', label: 'Branch Sell Account' },
  { name: 'profitAcBrnSale', label: 'Profit Account Branch Sell' },
...
export const PRODUCT_PROFILE_DETAIL_CHECKBOXES: IProductProfileCheckboxFieldConfig[] =
  [
    ...
    },
    {
      ...
      label: 'Pick Sell Rate Avg. as Settlement Rate?',
    },
    ...
    { name: 'reversalEffectOfProfits', label: 'Reversal effect of Profits?' },
    {
      ...
      label: 'Allow Changing Denomination in Sells?',
    },
