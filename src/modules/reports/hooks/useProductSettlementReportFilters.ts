...
import {
  ...
  ReportSortByEnum,
  type ICardSettlementReportFiltersState as IProductSettlementReportFiltersState,
...
export const useProductSettlementReportFilters = () => {
  ...
  const [appliedFilters, setAppliedFilters] =
    useState<IProductSettlementReportFiltersState | null>(
      searchParamsKey
        ? {
  ...
  const handleView = () => {
    const nextAppliedFilters: IProductSettlementReportFiltersState = {
      dateRange,
...
export type ProductSettlementReportFilters = ReturnType<
  typeof useProductSettlementReportFilters
>;

export { useProductSettlementReportFilters as useCardSettlementReportFilters };
export type { ProductSettlementReportFilters as CardSettlementReportFilters };
