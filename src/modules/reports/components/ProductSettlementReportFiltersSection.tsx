...
import { PRODUCT_SETTLEMENT_REPORT_TEXT } from '../constants/productSettlementReportConstants';
import type { ProductSettlementReportFilters } from '../hooks/useProductSettlementReportFilters';
import CheckboxFilterGroup from './CheckboxFilterGroup';
import ReportDatePresetFilter from './ReportDatePresetFilter';
import ReportSortByFilter from './ReportSortByFilter';

interface ProductSettlementReportFiltersSectionProps {
  filters: ProductSettlementReportFilters;
}

const buildSelectionDescription = (count: number, total: number) => {
  if (total === 0) {
    return PRODUCT_SETTLEMENT_REPORT_TEXT.noOptions;
  }

  return PRODUCT_SETTLEMENT_REPORT_TEXT.selectedOf(count, total);
};

export const ProductSettlementReportFiltersSection = ({
  filters,
}: ProductSettlementReportFiltersSectionProps) => {
  return (
    <section className="space-y-3 rounded-xl border border-border-primary bg-white p-3 shadow-sm">
      ...
      <div className="grid gap-3 xl:grid-cols-2">
        <CheckboxFilterGroup
          heading={PRODUCT_SETTLEMENT_REPORT_TEXT.branchHeading}
          ...
          emptyMessage={PRODUCT_SETTLEMENT_REPORT_TEXT.branchEmpty}
          ...
          loadingMessage={PRODUCT_SETTLEMENT_REPORT_TEXT.loadingOptions}
        />

        <CheckboxFilterGroup
          heading={PRODUCT_SETTLEMENT_REPORT_TEXT.productHeading}
          ...
          emptyMessage={PRODUCT_SETTLEMENT_REPORT_TEXT.productEmpty}
          helperText={buildSelectionDescription(
        ...
        <CheckboxFilterGroup
          heading={PRODUCT_SETTLEMENT_REPORT_TEXT.currencyHeading}
          ...
          emptyMessage={PRODUCT_SETTLEMENT_REPORT_TEXT.currencyEmpty}
          helperText={buildSelectionDescription(
        ...
        <CheckboxFilterGroup
          heading={PRODUCT_SETTLEMENT_REPORT_TEXT.issuerHeading}
          ...
          emptyMessage={PRODUCT_SETTLEMENT_REPORT_TEXT.issuerEmpty}
          helperText={buildSelectionDescription(
      ...
      <div className="flex flex-wrap items-center justify-end gap-2 border-t border-slate-100 pt-2">
        ...
        >
          {PRODUCT_SETTLEMENT_REPORT_TEXT.reset}
        </Button>
        <Button
          type="button"
          ...
          className="h-8 px-3 text-xs"
        >
          {PRODUCT_SETTLEMENT_REPORT_TEXT.viewReport}
        </Button>
      </div>
    </section>
  );
...
export default ProductSettlementReportFiltersSection;
