...
const HEADER_ROUTES: Array<{ path: string; meta: HeaderMeta }> = [
  ...
  { path: '/receipts', meta: { title: 'Receipts' } },
  { path: '/receipts/create', meta: { title: 'Create Receipt' } },
  { path: '/receipts/edit/:id', meta: { title: 'Receipt Details' } },
  { path: '/payments', meta: { title: 'Payments' } },
  ...
  { path: '/reports/generate-ledger', meta: { title: 'Generate Ledger' } },
  {
    ...
    meta: { title: 'Unsettled Product Report' },
  },
  {
    path: '/reports/card-settled-report',
    meta: { title: 'Settled Product Report' },
  },
  {
  ...
  { path: '/product-settlement', meta: { title: 'Product Settlement' } },
  {
    path: '/product-settlement/create',
    meta: { title: 'Create Product Settlement' },
  },
  {
  ...
  { path: '/card-settlement/edit/:id', meta: { title: 'Product Settlement' } },
  { path: '/card-settlement/:id', meta: { title: 'Product Settlement' } },
  ...
  { path: '/tt-settlement', meta: { title: 'Product Settlement' } },
  {
    path: '/tt-settlement/create',
    meta: { title: 'Create Product Settlement' },
  },
  { path: '/tt-settlement/edit/:id', meta: { title: 'Product Settlement' } },
  { path: '/tt-settlement/:id', meta: { title: 'Product Settlement' } },
