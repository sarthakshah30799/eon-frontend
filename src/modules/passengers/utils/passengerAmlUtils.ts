...
export const createStaticPassengerSelectOptions =
  <T extends string>(options: ReadonlyArray<{ value: T; label: string }>) =>
...
export const PASSENGER_NATIONALITY_OPTIONS = [
  ...
  value: PassengerNationalityType;
  label: string;
}>;
...
export const PASSENGER_OTHER_ID_PROOF_OPTIONS = [
  ...
  {
    value: PassengerOtherIdProofTypeEnum.DRIVING_LICENSE,
