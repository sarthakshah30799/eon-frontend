...
export const ffmcClientSchema = yup.object({
  dateOfIntro: yup.string().trim().optional(),
  isFfmc: yup.boolean().default(true),
  ...
  creditLimit: yup.number().typeError('Credit Limit must be a number').min(-1).optional().nullable(),
  creditDays: yup.number().integer().typeError('Credit Days must be a number').min(-1).optional().nullable(),
  temporaryCreditLimit: yup.number().typeError('Temporary Credit Limit must be a number').min(-1).optional().nullable(),
  temporaryCreditDays: yup.number().integer().typeError('Temporary Credit Days must be a number').min(-1).optional().nullable(),
  permanentCreditLimit: yup.number().typeError('Permanent Credit Limit must be a number').min(-1).optional().nullable(),
  permanentCreditDays: yup.number().integer().typeError('Permanent Credit Days must be a number').min(-1).optional().nullable(),
  ...
  chqTrxnLimit: yup.number().typeError('Chq Trxn Limit must be a number').min(-1).optional().nullable(),
...
export default ffmcClientSchema;
